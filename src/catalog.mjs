...
export const products = [
  ...
  { id: "OR-24018", sku: "CO-OS-118-SND", name: "Coastline Overshirt", category: "Shirts", season: "SS 2027", color: "Sand", status: "In review", completion: 96, evidence: 11, suppliers: 4, openItems: 1, recycledContent: 46, owner: "Noah Williams", updatedAt: "1 hr ago", nextAction: "Approve factory declaration", material: "46% recycled cotton, 54% organic cotton", chain: supplyChain.slice(0, 5) },
  { id: "OR-24019", sku: "ME-KN-220-CRM", name: "Meridian Knit", category: "Knitwear", season: "AW 2026", color: "Cream", status: "Passport ready", completion: 100, evidence: 18, suppliers: 5, openItems: 0, recycledContent: 60, owner: "Maya Chen", updatedAt: "2 hrs ago", nextAction: "Publish passport", material: "60% recycled wool, 40% organic cotton", image: "/product-meridian-knit.jpg", chain: verifiedSupplyChain.slice(0, 5) },
  { id: "OR-24020", sku: "FO-TR-305-BLK", name: "Forma Tailored Trouser", category: "Bottoms", season: "Core", color: "Black", status: "At risk", completion: 71, evidence: 9, suppliers: 7, openItems: 6, recycledContent: 38, owner: "Imani Cole", updatedAt: "Yesterday", nextAction: "Replace expired certificate", material: "38% recycled wool, 62% viscose", chain: supplyChain },
  { id: "OR-24021", sku: "NI-TS-014-WHT", name: "Nila Everyday Tee", category: "Jersey", season: "Core", color: "White", status: "Needs evidence", completion: 89, evidence: 8, suppliers: 3, openItems: 2, recycledContent: 25, owner: "Noah Williams", updatedAt: "Yesterday", nextAction: "Confirm origin declaration", material: "100% organic cotton", chain: supplyChain.slice(0, 4) },
  { id: "OR-24022", sku: "TE-SH-901-MOS", name: "Tera Storm Shell", category: "Outerwear", season: "AW 2026", color: "Moss", status: "Passport ready", completion: 100, evidence: 24, suppliers: 8, openItems: 0, recycledContent: 86, owner: "Maya Chen", updatedAt: "Jul 30", nextAction: "Monitor evidence validity", material: "86% recycled nylon, 14% elastane", chain: verifiedSupplyChain },
];
